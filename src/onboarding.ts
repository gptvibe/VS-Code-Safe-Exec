...
export function createOnboardingMarkdown(options: {
  ...
  return [
    ...
    "## Layered Hardening",
    "",
    "- Safe Exec is a guardrail, review, and bounded recovery layer inside VS Code.",
    "- Workspace Trust can reduce some automatic workspace behavior, but it is not a sandbox.",
    "- Agent hooks can reject or reshape risky automation before it reaches the terminal, editor, or command surface.",
    "- Containers, VMs, remote hosts, and low-privilege accounts provide isolation that Safe Exec does not claim to replace.",
    "- Open `Safe Exec: Open Hardening Checklist` for a defense-in-depth checklist plus starter templates for dev containers, Docker-based workspaces, and hook guidance.",
    "",
    ...
    "- Open `Safe Exec: Open Hardening Checklist` to plan how Safe Exec fits with Workspace Trust, agent hooks, and sandboxing.",
